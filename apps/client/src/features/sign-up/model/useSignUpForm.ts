...
import { getVerifyEmail } from '@/features/sign-up/api/verify-email.api';
import { getVerifyNickname } from '@/features/sign-up/api/verify-nickname.api';
...
} from '@/shared/model/validation-status';
